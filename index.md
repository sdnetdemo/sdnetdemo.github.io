...
<audio controls="" style="width: 200px; height: 50px"><source src="data/noisy/1.wav" type="audio/wav"></audio><audio controls="" style="width: 200px; height: 50px"><source src="data/predict/1.wav" type="audio/wav"></audio><audio controls="" style="width: 200px; height: 50px"><source src="data/clean/1.wav" type="audio/wav"></audio>
